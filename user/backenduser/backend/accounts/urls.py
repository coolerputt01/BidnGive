...
from .views import RegisterView, CustomTokenObtainPairView, VerifyEmailOTPView,SendWhatsAppOTP,verify_whatsapp_otp,UserProfileView,enter_auction_room,ResendEmailOTP
urlpatterns = [
